...
class DataProvider:
    def __init__(
            ...
            shuffle: bool = True,
            initial_epoch: int = 1,
            augmentors: typing.List[Augmenter] = None,
    ...
    @property
    def augmentors(self) -> typing.List[Augmenter]:
        """ Return augmentors """
        return self._augmentors

    @augmentors.setter
    def augmentors(self, augmentors: typing.List[Augmenter]):
        """ Decorator for adding augmentors to the DataProvider """
        for augmentor in augmentors:
            if isinstance(augmentor, Augmenter):
